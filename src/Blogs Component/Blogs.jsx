...
export default function Blogs() {
    ...
    return (
        <>
            <div className="bg-zinc-300 w-full h-[100%] px-11 py-11 text-center grid grid-cols-3 gap-4">
                ...
                {data.slice(0,more).map((value, index) =>
                    ...
                    <div key={index} className="bg-red-300 w-[200px] rounded-lg border-4 border-solid border-[black] h-auto px-6 py-6 text-center">
                        ...
                        <NavLink to={`/movie/${value.id}`}>
                            <button onClick={() => getmore()} className="bg-blue-100 w-[120px] h-[40px] px-4 py-2 rounded-md text-[12px] font-semibold text-blue-600 mt-[1rem]">More blogs</button>
                        </NavLink>
